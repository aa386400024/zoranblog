...
app.use(expressJWT({
  ...
  path: ['/api/user/register','/api/user/login','/api/user/upload', '/api/article/upload', '/api/article/allList','/api/article/detail','/api/comment/list', '/api/banner/upload', '/api/banner/allBanner', '/api/friendlylink/allFriendly', '/api/friendlylink/upload',]  //白名单,除了这里写的地址，其他的URL都需要验证
}));
